# Vendored from https://github.com/maweigert/betterplots
# 3a2c3bd7646290c5748e463553f33368ea8253bd.
# Copyright Martin Weigert (BSD-3-Clause).
...
from seaborn.categorical import (
    _CategoricalPlotter,  # type: ignore[missing-module-attribute]
)
from seaborn.utils import _default_color  # type: ignore[missing-module-attribute]
...
def boxstripplot(
    ...
    box_kwargs.setdefault("boxprops", {})
    box_kwargs.setdefault("whiskerprops", {})
    box_kwargs.setdefault("capprops", {})
