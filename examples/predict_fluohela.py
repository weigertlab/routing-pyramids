"""Write CTC segmentations from a Fluo-N2DL-HeLa routing-pyramid checkpoint."""
...
CHECKPOINT = Path(
    "outputs/hela/pyramid_flow_vae/"
    "dim_256_8x8_64-fg_1e-2-bg_5e-2-flow_5e-3-entropy_0-sparsity_2e-1-200ep/"
    "checkpoints/last.ckpt"
)
OUTPUT_DIR = Path("predictions/hela")
